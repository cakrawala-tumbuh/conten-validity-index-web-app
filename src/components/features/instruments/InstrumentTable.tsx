  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-1.5">
        <h3 className="text-sm font-medium text-gray-700">Daftar Instrumen</h3>
        <TableInfoTooltip description="Daftar seluruh instrumen penelitian beserta deskripsi dan statusnya. Klik Detail untuk mengelola domain, item, penugasan expert, dan melihat hasil CVI." />
      </div>

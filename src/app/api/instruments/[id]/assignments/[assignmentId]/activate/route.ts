/**
 * API route proxy untuk endpoint aktifkan kembali penilaian assignment instrumen.
 *
...
/**
 * Menangani POST /api/instruments/[id]/assignments/[assignmentId]/activate.
 *
 * Mengaktifkan kembali penilaian assignment yang sebelumnya dinonaktifkan
 * sehingga kembali diperhitungkan dalam kalkulasi CVI.
 *
 ...
 * @returns AssignmentResponse dengan `is_active: true`, atau pesan error.
 */
export async function POST(_request: NextRequest, { params }: RouteParams): Promise<NextResponse> {
  ...
  const backendResp = await fetch(
    `${backendUrl}/api/v1/instruments/${id}/assignments/${assignmentId}/activate`,
    {
      method: "POST",

/**
 * API route proxy untuk endpoint daftar pengguna backend.
 *
 * Meneruskan request GET (list users) dari browser ke backend FastAPI
...
/**
 * Menangani GET /api/users — mengambil daftar semua pengguna (admin only).
 *
 * @param request - HTTP request dari client, opsional query params skip/limit.
 * @returns Array data pengguna atau pesan error.
 */

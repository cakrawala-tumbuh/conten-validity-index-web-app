# ============================================================
# Stage 1: deps — Install semua dependensi Node.js
# ============================================================
FROM node:20-alpine AS deps

WORKDIR /app

# Install libc6-compat untuk kompatibilitas beberapa package
...
# ============================================================
# Stage 3: test — Menjalankan unit test (digunakan oleh CI)
# ============================================================
...
# Salin file statis dari builder
COPY --from=builder /app/public ./public

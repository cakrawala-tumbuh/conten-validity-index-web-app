...
dilakukan oleh sistem (bukan pengguna tertentu) ditandai sebagai *sistem*.
...
1. **Jenis Aksi** — pilih jenis aktivitas tertentu (mis. *Update Pengguna*,
   *Nonaktifkan Pengguna*), atau biarkan **Semua aksi**.
2. **Dari Tanggal** — batas awal rentang waktu.
3. **Sampai Tanggal** — batas akhir rentang waktu.
4. Klik **Terapkan Filter**.

Bila tidak ada data yang cocok, tampil pesan *"Tidak ada log aktivitas ditemukan."*
